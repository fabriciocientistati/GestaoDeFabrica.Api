...
namespace FabricaGestao.Api.Migrations
{
    ...
    [Migration("20241221204751_Alteracao_nomes_tabelas")]
    partial class Alteracao_nomes_tabelas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FabricaGestao.Api.Modelos.CategoriaModelo", b =>
                {
            ...
            modelBuilder.Entity("FabricaGestao.Api.Modelos.OrcamentoModelo", b =>
                {
            ...
            modelBuilder.Entity("FabricaGestao.Api.Modelos.OrcamentoProdutoModelo", b =>
                {
                    b.Property<int>("OrcId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FabricaGestao.Api.Modelos.PerfilModelo", b =>
                {
                    ...
                    b.Property<DateTime?>("PerAltEm")
                        .HasColumnType("datetime2");

                    b.Property<int?>("PerAltPor")
                        .HasColumnType("int");

                    b.Property<DateTime>("PerIncEm")
                        .HasColumnType("datetime2");

                    b.Property<int>("PerIncPor")
                        .HasColumnType("int");

                    b.Property<string>("PerNome")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FabricaGestao.Api.Modelos.PessoaModelo", b =>
                {
                    b.Property<int>("PesId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FabricaGestao.Api.Modelos.ProdutoModelo", b =>
                {
                    b.Property<int>("ProId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FabricaGestao.Api.Modelos.UsuarioModelo", b =>
                {
            ...
            modelBuilder.Entity("FabricaGestao.Api.Modelos.OrcamentoModelo", b =>
                {
                    b.HasOne("FabricaGestao.Api.Modelos.PessoaModelo", "Pessoa")
                        .WithMany("Orcamentos")
                        .HasForeignKey("PesId")
            ...
            modelBuilder.Entity("FabricaGestao.Api.Modelos.OrcamentoProdutoModelo", b =>
                {
                    b.HasOne("FabricaGestao.Api.Modelos.OrcamentoModelo", "Orcamento")
                        .WithMany("OrcamentoProdutos")
                        .HasForeignKey("OrcId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FabricaGestao.Api.Modelos.ProdutoModelo", "Produto")
            ...
            modelBuilder.Entity("FabricaGestao.Api.Modelos.ProdutoModelo", b =>
                {
                    b.HasOne("FabricaGestao.Api.Modelos.CategoriaModelo", "Categoria")
            ...
            modelBuilder.Entity("FabricaGestao.Api.Modelos.UsuarioModelo", b =>
                {
                    b.HasOne("FabricaGestao.Api.Modelos.PerfilModelo", "Perfil")
                        .WithMany("Usuarios")
                        .HasForeignKey("PerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
